...
module.exports = async function (context, req) {
  ...
  const collectionTransferencias = database.collection("transferencias");

  let list = await collectionTransferencias.find({}).toArray();

  registros = list.filter( list => list.cuenta_origen == req.body._id || list.cuenta_destino == req.body._id)
